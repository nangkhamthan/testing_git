...
<body>
			...
			<div class="col-xl-6 col-lg-6 col-md-4 col-sm-2 col-2 order-xl-2 order-lg-2 order-md-3 order-sm-3 order-3">
				<div class="row">
					<div class="col-lg-8 col-2 ">
						...
						<a href="{{route('loginpage')}}" class="d-xl-block d-lg-block d-md-block d-none  text-decoration-none loginLink float-right">  Sign-up  | </a>  --}}
			...
			<div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6 order-xl-3 order-lg-3 order-md-4 order-sm-4 order-4 text-right">
				...
				<a href="{{route('shoppingcartpage')}}" class="text-decoration-none d-xl-inline d-lg-inline d-md-inline d-sm-none d-none shoppingcartLink"> 
					...
					<span class="badge badge-pill badge-light badge-notify cartNotistyle cartNoti cart_item_count">0</span>
					 <span id="total"></span>Ks 
				</a>

				<a href="" class="text-decoration-none d-xl-none d-lg-none d-md-none d-sm-inline-block d-inline-block shoppingcartLink"> 
					<i class="icofont-shopping-cart"></i>
					<span class="badge badge-pill badge-light badge-notify cartNotistyle cartNoti cart_item_count"> 1 </span>
				</a>
	...
	<div class="container subNav d-xl-block d-lg-block d-none my-3">
		<div class="row align-items-center">
			<div class="col-3 align-items-center">
				<p class="d-inline">Shop By</p>
				<a href="{{route('mainpage')}}" class="d-inline pr-3 icofont-home" style="color: violet" ></a>
	...
	<div id="mySidebar" class="sidebar">
		...
		<div class="mt-3">
			...
			<a href="{{route('shoppingcartpage')}}"> Cart [ <span class="cartNoti"> 1 </span> ]  </a>
			<hr>
