		                ...
		                <div class="item">
		                    <div class="pad15">
		                    	<a href="{{route('itemdetailpage',$item->id)}}">
										...
										data-id="{{$item->id}}" data-name="{{$item->name}}" data-price="{{$item->price}}"  data-discount="{{$item->discount}}" data-photo="{{asset($item->photo)}}">Add to Cart</a>
									</a>
		                    </div>
		            ...
		            <div class="MultiCarousel-inner">
		                ...
		                <div class="item">
		                    <div class="pad15">
								...
								<a href="{{route('shoppingcartpage')}}" class="addtocartBtn text-decoration-none">Add to Cart</a>
	...
	<div>
	    ...
	    <section class="customer-logos slider mt-5">
	    	@foreach($brands as $brand)
	      	<div class="slide">
	      		<a href="{{route('itembybrandpage',$brand->id)}}">
